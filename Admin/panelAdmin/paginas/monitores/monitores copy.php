...
//Si se ha dado al botón llamado actualizaMonitor que está en actualizarMonitor.php entra
if (isset($_POST['actualizaMonitor'])) {
    if (
                                ...
                                <tr>
                                    ...
                                    <form method="post">
                                        ...
                                        <td>
                                            ...
                                            <button type="submit" name="botonMod" class="icono" style="background-color: transparent;"><i class="icofont-options icono"></i></button>
