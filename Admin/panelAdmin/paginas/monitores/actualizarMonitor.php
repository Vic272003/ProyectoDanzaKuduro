...
if (isset($_POST['actualizarMonitor'])) {
    if (
        ...
        $prueba = Monitor::actualizarMonitor($dni, $nombre, $apellidos, $password); //Llamamos a la función de la clase Monitor
        if ($prueba) { ?>
...
?>
<!-- Modal -->
<div class="modal fade" id="actualizararMonitor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Actualizar Monitor</h1>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="actualizarMonitor" class="btn btn-primary">Actualizar</button>
                </form>
            </div>
        </div>
    </div>
