...
if (isset($_POST['crearMonitor'])) {
    if (
        ...
        $grupo=$_POST['grupoActualizar'];
        $crearMonitor = Monitor::crearMonitor($dni, $nombre, $apellidos, $password, $dniGestor,$grupo);  //Hacemos una llamada a la función
        if ($crearMonitor) { ?>
            <div class="alert alert-success mt-0" role="alert">
                Monitor creado correctamente!
...
?>
<!-- Modal -->
<div class="modal fade" id="crearMonitor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Crear Monitor</h1>
                    ...
                    <form method="post">
                        ...
                        <div class="row">
                            <div class="form-group mt-2 col-md">
                                ...
                                <select name="grupoActualizar" class="form-control">
                                    <?php
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="crearMonitor" class="btn btn-primary">Crear</button>
                </form>
            </div>
        </div>
    </div>
